...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    body: "A napkin idea becomes a ten-storey statement. We plan, permit and produce murals at architectural scale — engineered to survive weather, light and time.",
  ...
  },
  {
    ...
    body: "We bring artists, brands and city programs into one room. Clear briefs, shared authorship, and murals that serve the neighbourhood as much as the logo.",
  ...
  },
  {
    ...
    body: "A wall can shift how a street feels — slow traffic, draw footfall, give a block its name back. We measure success in the life that gathers around the work.",
